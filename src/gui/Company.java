...
public class Company extends javax.swing.JDialog {
    ...
    public Company(Phamarcy parent, boolean modal, CompanyBranch cb) {
        super(parent, modal);
        initComponents();
        this.cb = cb;
    ...
    private void initComponents() {
        ...
        setTitle("Company");
        setMinimumSize(new java.awt.Dimension(405, 489));
        ...
        if (name.isEmpty()) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    MySQL.iud("INSERT INTO `company` (`name`) VALUES ('" + name + "')");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            int r = jTable1.getSelectedRow();
            if (r != -1) {
                this.cb.jCompanyId.setText(jTable1.getValueAt(r, 0).toString());
                this.cb.jLabel14.setText(jTable1.getValueAt(r, 1).toString());
                this.dispose();
            }
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (name.isEmpty()) {
            ...
            try {
                ResultSet rs = MySQL.search("SELECT * FROM `company` WHERE `name`='" + name + "'");
                if (!rs.next()) {
                    MySQL.iud("UPDATE `company` SET `name`='" + name + "' WHERE `id`='" + id + "'");
