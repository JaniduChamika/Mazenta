...
public class BrandRegistration extends javax.swing.JDialog {
    ...
    public BrandRegistration(Phamarcy parent, boolean modal, Medicine med) {
        super(parent, modal);
        initComponents();
        this.p = parent;
        this.med = med;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (name.isEmpty()) {
            ...
            try {
                ResultSet rs = MySQL.search("SELECT * FROM `brand` WHERE `name`='" + name.replaceAll("'", "\\\\'") + "'");
                if (rs.next()) {

                } else {
                    MySQL.iud("UPDATE `brand` SET `name`='" + name.replaceAll("'", "\\\\'") + "' WHERE `id`='" + id + "'");
                }
                jName.setText("");
                loadBrand();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (name.isEmpty()) {
            ...
            try {
                ResultSet rs = MySQL.search("SELECT * FROM `brand` WHERE `name`='" + name.replaceAll("'", "\\\\'") + "'");
                if (rs.next()) {
                    JOptionPane.showMessageDialog(this, "Already exist brand ", "Warning", JOptionPane.WARNING_MESSAGE);

                } else {
                  
                    MySQL.iud("INSERT INTO `brand` (`name`) VALUES ('" + name.replaceAll("'", "\\\\'") + "')");
